...
RGERegisterModel["MSSMTriplet","REAP`RGEMSSMTriplet`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max,RGE\[Kappa]->`Private`Get\[Kappa],RGEMu->`Private`GetMu,RGEMe->`Private`GetMe,RGEMNur->`Private`GetM\[Nu]r,RGERawY\[CapitalDelta]->`Private`GetRawY\[CapitalDelta],RGECoupling->`Private`GetCoupling,RGEYd->`Private`GetYd,RGEMixingParameters->`Private`GetMixingParameters,RGEPoleMTop->`Private`GetPoleMTop,RGEM1Tilde->`Private`GetM1Tilde,RGE\[Alpha]->`Private`Get\[Alpha],RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEYe->`Private`GetYe,RGEYu->`Private`GetYu,RGE\[Epsilon]->`Private`Get\[Epsilon],RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGEMNu->`Private`GetM\[Nu],RGETwistingParameters->`Private`GetTwistingParameters,RGERaw->`Private`GetRawSolution,RGEAll->`Private`GetSolution,RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max,RGEMd->`Private`GetMd,RGEY\[Nu]->`Private`GetY\[Nu],RGEM\[CapitalDelta]->`Private`GetM\[CapitalDelta],RGERawY\[Nu]->`Private`GetRawY\[Nu]},
...
ParameterSymbols={RGEg1,RGEg2,RGEg3,RGEYu,RGEYd,RGEYe,RGEY\[Nu],RGEY\[CapitalDelta],RGE\[Kappa],RGEMNur,RGE\[CapitalLambda]u,RGE\[CapitalLambda]d,RGEM\[CapitalDelta]};
...
{"GUT",{
	...
	RGEMNur->RGEGetM[RGE\[Theta]12,RGE\[Theta]13,RGE\[Theta]23,RGE\[Delta],RGE\[Delta]e,RGE\[Delta]\[Mu],RGE\[Delta]\[Tau],RGE\[CurlyPhi]1,RGE\[CurlyPhi]2,RGEMlightest,RGE\[CapitalDelta]m2atm,RGE\[CapitalDelta]m2sol,RGEMassHierarchy,RGEvu,RGEY\[Nu],RGE\[Kappa],RGEY\[CapitalDelta],RGE\[CapitalLambda]u,RGEM\[CapitalDelta]],
...
(* calculate the new parameters *)
	...
	If[lToIntegratedOut>lFromIntegratedOut,
        ...
        Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu,RGEYd->lYd,RGEYe->lYe,RGEY\[Nu]->lY\[Nu],RGEY\[CapitalDelta]->lY\[CapitalDelta],RGE\[Kappa]->l\[Kappa],RGEMNur->lM\[Nu]r,RGE\[CapitalLambda]u->l\[CapitalLambda]u,RGE\[CapitalLambda]d->l\[CapitalLambda]d,RGEM\[CapitalDelta]->lM\[CapitalDelta]}];
];
...
(* calculate the new parameters *)
	...
	If[lToIntegratedOut>lFromIntegratedOut,
        ...
        Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu,RGEYd->lYd,RGEYe->lYe,RGEY\[Nu]->lY\[Nu],RGE\[Kappa]->l\[Kappa],RGEMNur->lM\[Nu]r}];
];
...
(* calculate the new parameters *)
	...
	le=lcb/lTocb;
        ...
        Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu*lu,RGEYd->lYd*ld,RGEYe->lYe*le,RGEY\[Nu]->lY\[Nu]*l\[Nu],RGE\[Kappa]1->(RGEz\[Nu]/.Options[lToOpts,RGEz\[Nu]])[[1]]*l\[Kappa]*(l\[Nu])^2,RGE\[Kappa]2->(RGEz\[Nu]/.Options[lToOpts,RGEz\[Nu]])[[2]]*l\[Kappa]*(l\[Nu])^2,RGEMNur->lM\[Nu]r,RGE\[Lambda]1->(lg2^2+lg1^2)/2.,RGE\[Lambda]2->(lg2^2+lg1^2)/2.,RGE\[Lambda]3->(lg2^2-lg1^2)/4,RGE\[Lambda]4->-(lg2^2)/2,RGE\[Lambda]5->0.}];
];
...
(* calculate the new parameters *)
	...
	lcb=1/Sqrt[1+RGEtan\[Beta]^2]/.Options[lFromOpts,RGEtan\[Beta]];
	lsb=RGEtan\[Beta]/Sqrt[1+RGEtan\[Beta]^2]/.Options[lFromOpts,RGEtan\[Beta]];
	Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu*lsb,RGEYd->lYd*lcb,RGEYe->lYe*lcb,RGEY\[Nu]->lY\[Nu]*lsb,RGEY\[CapitalDelta]->lY\[CapitalDelta]*(lsb)^2,RGE\[Kappa]->l\[Kappa]*(lsb)^2,RGEMNur->lM\[Nu]r,RGE\[Lambda]->(RGE\[Lambda]/.Options[lToOpts,RGE\[Lambda]]),RGE\[CapitalLambda]6->l\[CapitalLambda]u*lM\[CapitalDelta],RGEM\[CapitalDelta]2->lM\[CapitalDelta]^2}];
];
...
(* calculate the new parameters *)
	...
	lcb=1/Sqrt[1+RGEtan\[Beta]^2]/.Options[lFromOpts,RGEtan\[Beta]];
	lsb=RGEtan\[Beta]/Sqrt[1+RGEtan\[Beta]^2]/.Options[lFromOpts,RGEtan\[Beta]];
	Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu*lsb,RGEYd->lYd*lcb,RGEYe->lYe*lcb,RGEY\[Nu]->lY\[Nu]*lsb,RGE\[Kappa]->l\[Kappa]*(lsb)^2,RGEMNur->lM\[Nu]r,RGE\[Lambda]->(RGE\[Lambda]/.Options[lToOpts,RGE\[Lambda]])}];
];

...
RGERegisterModel["MSSMTriplet0N","REAP`RGEMSSMTriplet0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEMd->`Private`GetMd,RGEPoleMTop->`Private`GetPoleMTop,RGE\[Kappa]->`Private`Get\[Kappa],RGERawY\[CapitalDelta]->`Private`GetRawY\[CapitalDelta],RGEYu->`Private`GetYu,RGETwistingParameters->`Private`GetTwistingParameters,RGECoupling->`Private`GetCoupling,RGEMixingParameters->`Private`GetMixingParameters,RGEMNu->`Private`GetM\[Nu],RGEYd->`Private`GetYd,RGEYe->`Private`GetYe,RGERaw->`Private`GetRawSolution,RGEAll->`Private`GetSolution,RGEMu->`Private`GetMu,RGEM\[CapitalDelta]->`Private`GetM\[CapitalDelta],RGEMNur->`Private`GetM\[Nu]r,RGE\[Alpha]->`Private`Get\[Alpha],RGEY\[Nu]->`Private`GetY\[Nu],RGEMe->`Private`GetMe},
...
(* calculate the new parameters *)
	{lg1,lg2,lg3,lYu,lYd,lYe,lY\[CapitalDelta],l\[Kappa],l\[CapitalLambda]u,l\[CapitalLambda]d,lM\[CapitalDelta]}=(ParametersFunc[ pScale ]/.pSolution)[[1]];
        l\[Kappa]-=2 l\[CapitalLambda]u/lM\[CapitalDelta] * lY\[CapitalDelta];
	Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu,RGEYd->lYd,RGEYe->lYe,RGE\[Kappa]->l\[Kappa],RGEY\[Nu]->{},RGEMNur->{}}];
];
...
(* calculate the new parameters *)
	...
	Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu,RGEYd->lYd,RGEYe->lYe,RGEY\[CapitalDelta]->lY\[CapitalDelta],RGE\[Kappa]->l\[Kappa],RGEY\[Nu]->{},RGEMNur->{},RGE\[CapitalLambda]u->l\[CapitalLambda]u,RGE\[CapitalLambda]d->l\[CapitalLambda]d,RGEM\[CapitalDelta]->lM\[CapitalLambda]}];
];
...
*)
	...
	RGEMNur->{},RGE\[Lambda]1->(lg2^2+lg1^2)/2.,RGE\[Lambda]2->(lg2^2+lg1^2)/2.,RGE\[Lambda]3->(lg2^2-lg1^2)/4,RGE\[Lambda]4->-(lg2^2)/2,RGE\[Lambda]5->0.}];
];
(* changed transition function to 2HDM such that D-terms are correctly taken into account, although there is less flexibility *)
(*,RGE\[Lambda]1->(RGE\[Lambda]1/.Options[lToOpts,RGE\[Lambda]1]),RGE\[Lambda]2->(RGE\[Lambda]2/.Options[lToOpts,RGE\[Lambda]2]),RGE\[Lambda]3->(RGE\[Lambda]3/.Options[lToOpts,RGE\[Lambda]3]),RGE\[Lambda]4->(RGE\[Lambda]4/.Options[lToOpts,RGE\[Lambda]4]),RGE\[Lambda]5->(RGE\[Lambda]5/.Options[lToOpts,RGE\[Lambda]5]) *)
...
*)
	...
	Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu*lsb,RGEYd->lYd*lcb,RGEYe->lYe*lcb,RGE\[Kappa]->l\[Kappa]*(lsb)^2,RGEMNur->{},RGE\[Lambda]->(RGE\[Lambda]/.Options[lToOpts,RGE\[Lambda]])}]; (* !!! Parameters !!!*)
];
...
*)
	...
	Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu*lsb,RGEYd->lYd*lcb,RGEYe->lYe*lcb,RGEY\[CapitalDelta]->lY\[CapitalDelta]*(lsb)^2,RGE\[Kappa]->l\[Kappa]*(lsb)^2,RGEMNur->{},RGE\[Lambda]->(RGE\[Lambda]/.Options[lToOpts,RGE\[Lambda]]),RGE\[CapitalLambda]6->l\[CapitalLambda]u*lM\[CapitalDelta],RGEM\[CapitalDelta]2->lM\[CapitalDelta]^2}]; (* !!! Parameters !!!*)
];

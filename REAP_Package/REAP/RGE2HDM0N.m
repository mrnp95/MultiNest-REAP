...
BeginPackage["REAP`RGE2HDM0N`",{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`",
"REAP`RGESM`"}];
...
RGERegisterModel["2HDM0N","REAP`RGE2HDM0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Kappa]1->`Private`Get\[Kappa]1,RGEMNu->`Private`GetM\[Nu],RGETwistingParameters->`Private`GetTwistingParameters,RGERaw->`Private`GetRawSolution,RGEPoleMTop->`Private`GetPoleMTop,RGEYd->`Private`GetYd,RGEYu->`Private`GetYu,RGEMixingParameters->`Private`GetMixingParameters,RGE\[Alpha]->`Private`Get\[Alpha],RGEYe->`Private`GetYe,RGEAll->`Private`GetSolution,RGEMNur->`Private`GetM\[Nu]r,RGEMe->`Private`GetMe,RGEMd->`Private`GetMd,RGEMu->`Private`GetMu,RGE\[Kappa]2->`Private`Get\[Kappa]2,RGE\[Lambda]->`Private`Get\[Lambda],RGECoupling->`Private`GetCoupling,RGEY\[Nu]->`Private`GetY\[Nu]},
{{"MSSM",`Private`TransMSSM},{"MSSM0N",`Private`TransMSSM0N},{"2HDM0N",`Private`Trans2HDM0N}},
        `Private`GetInitial,
...
Begin["`Private`"];
Map[Needs,{"REAP`RGESymbol`", "REAP`RGESolver`","REAP`RGEUtilities`", "REAP`RGEParameters`","REAP`RGEInitial`","MixingParameterTools`MPT3x3`", "REAP`RGESM`"}];
...
(* calculate the new parameters *)
	...
	Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu*lu,RGEYd->lYd*ld,RGEYe->lYe*le,RGE\[Kappa]->(l\[Kappa]1+l\[Kappa]2)*(l\[Nu])^2,RGEY\[Nu]->{},RGEMNur->{}}];
];

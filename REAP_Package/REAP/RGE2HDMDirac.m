...
RGERegisterModel["2HDMDirac","REAP`RGE2HDMDirac`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEMu->`Private`GetMu,RGE\[Alpha]->`Private`Get\[Alpha],RGEYu->`Private`GetYu,RGERaw->`Private`GetRawSolution,RGEMNu->`Private`GetM\[Nu],RGEMd->`Private`GetMd,RGEYd->`Private`GetYd,RGEYe->`Private`GetYe,RGEPoleMTop->`Private`GetPoleMTop,RGEMe->`Private`GetMe,RGE\[Lambda]->`Private`Get\[Lambda],RGEAll->`Private`GetRawSolution,RGEY\[Nu]->`Private`GetY\[Nu],RGECoupling->`Private`GetCoupling},

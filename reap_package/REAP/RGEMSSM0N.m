...
RGERegisterModel["MSSM0N","REAP`RGEMSSM0N`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Kappa]->`Private`Get\[Kappa],RGEMixingParameters->`Private`GetMixingParameters,RGEMd->`Private`GetMd,RGECoupling->`Private`GetCoupling,RGETwistingParameters->`Private`GetTwistingParameters,RGEMNu->`Private`GetM\[Nu],RGEMNur->`Private`GetM\[Nu]r,RGEYd->`Private`GetYd,RGERaw->`Private`GetRawSolution,RGEPoleMTop->`Private`GetPoleMTop,RGEYe->`Private`GetYe,RGEMe->`Private`GetMe,RGEY\[Nu]->`Private`GetY\[Nu],RGEAll->`Private`GetSolution,RGEMu->`Private`GetMu,RGE\[Alpha]->`Private`Get\[Alpha],RGEYu->`Private`GetYu},

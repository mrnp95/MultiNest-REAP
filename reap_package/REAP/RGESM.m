...
RGERegisterModel["SM","REAP`RGESM`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEY\[Nu]->`Private`GetY\[Nu],RGEMd->`Private`GetMd,RGE\[Epsilon]->`Private`Get\[Epsilon],RGEMe->`Private`GetMe,RGEPoleMTop->`Private`GetPoleMTop,RGETwistingParameters->`Private`GetTwistingParameters,RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max,RGEMNu->`Private`GetM\[Nu],RGERawY\[Nu]->`Private`GetRawY\[Nu],RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGEAll->`Private`GetSolution,RGE\[Alpha]->`Private`Get\[Alpha],RGEMixingParameters->`Private`GetMixingParameters,RGEM1Tilde->`Private`GetM1Tilde,RGE\[Kappa]->`Private`Get\[Kappa],RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGEYu->`Private`GetYu,RGEMu->`Private`GetMu,RGERaw->`Private`GetRawSolution,RGEYd->`Private`GetYd,RGE\[Lambda]->`Private`Get\[Lambda],RGECoupling->`Private`GetCoupling,RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max,RGEYe->`Private`GetYe,RGEMNur->`Private`GetM\[Nu]r},
...
ParameterSymbols={RGEg1,RGEg2,RGEg3,RGEYu,RGEYd,RGEYe,RGEY\[Nu],RGE\[Kappa],RGEMNur,RGE\[Lambda]};
...
(* calculate the new parameters *)
	...
	l\[Beta]=N[ArcTan[RGEtan\[Beta]]]/.Options[lToOpts,RGEtan\[Beta]];
        ...
        Return[{RGEg1->lg1,RGEg2->lg2,RGEg3->lg3,RGEYu->lYu/Sin[l\[Beta]],RGEYd->lYd/Cos[l\[Beta]],RGEYe->lYe/Cos[l\[Beta]],RGE\[Kappa]->l\[Kappa]/Sin[l\[Beta]]^2,RGEY\[Nu]->lY\[Nu]/Sin[l\[Beta]],RGEMNur->lM}];
];

...
ClearAll[RGEMNur]; RGEMNur; Protect[RGEMNur];
...
RGEMNu, RGEMd, RGEMixingParameters, RGECoupling,RGE\[Epsilon]1,RGE\[Epsilon]1Max,RGE\[Epsilon],RGE\[Epsilon]Max,RGEM1Tilde,RGE\[Beta]1,RGE\[Beta]2,RGE\[Beta]3,RGEf1,RGEYqp,RGEYqm,RGEYlp,RGEYlm];

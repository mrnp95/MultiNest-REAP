...
RGERegisterModel["MSSM","REAP`RGEMSSM`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGE\[Alpha]->`Private`Get\[Alpha],RGEYd->`Private`GetYd,RGECoupling->`Private`GetCoupling,RGEPoleMTop->`Private`GetPoleMTop,RGE\[Epsilon]1->`Private`Get\[Epsilon]1,RGEY\[Nu]->`Private`GetY\[Nu],RGE\[Epsilon]Max->`Private`Get\[Epsilon]Max,RGERaw->`Private`GetRawSolution,RGERawM\[Nu]r->`Private`GetRawM\[Nu]r,RGE\[Epsilon]->`Private`Get\[Epsilon],RGE\[Kappa]->`Private`Get\[Kappa],RGEMe->`Private`GetMe,RGETwistingParameters->`Private`GetTwistingParameters,RGEMu->`Private`GetMu,RGEMd->`Private`GetMd,RGEM1Tilde->`Private`GetM1Tilde,RGERawY\[Nu]->`Private`GetRawY\[Nu],RGEYu->`Private`GetYu,RGEMNu->`Private`GetM\[Nu],RGEMixingParameters->`Private`GetMixingParameters,RGEMNur->`Private`GetM\[Nu]r,RGEYe->`Private`GetYe,RGEAll->`Private`GetSolution,RGE\[Epsilon]1Max->`Private`Get\[Epsilon]1Max},
...
ParameterSymbols={RGEg1,RGEg2,RGEg3,RGEYu,RGEYd,RGEYe,RGEY\[Nu],RGE\[Kappa],RGEMNur};
...
{"GUT",{
	...
	RGEMNur->RGEGetM[RGE\[Theta]12,RGE\[Theta]13,RGE\[Theta]23,RGE\[Delta],RGE\[Delta]e,RGE\[Delta]\[Mu],RGE\[Delta]\[Tau],RGE\[CurlyPhi]1,RGE\[CurlyPhi]2,RGEMlightest,RGE\[CapitalDelta]m2atm,RGE\[CapitalDelta]m2sol,RGEMassHierarchy,RGEvu,RGEY\[Nu]],

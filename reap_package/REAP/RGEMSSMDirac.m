...
RGERegisterModel["MSSMDirac","REAP`RGEMSSMDirac`",
	`Private`GetParameters,
        `Private`SolveModel,
        {RGEAll->`Private`GetRawSolution,RGEMe->`Private`GetMe,RGEPoleMTop->`Private`GetPoleMTop,RGEYu->`Private`GetYu,RGERaw->`Private`GetRawSolution,RGEMu->`Private`GetMu,RGE\[Alpha]->`Private`Get\[Alpha],RGEMd->`Private`GetMd,RGEMNu->`Private`GetM\[Nu],RGEY\[Nu]->`Private`GetY\[Nu],RGEYd->`Private`GetYd,RGECoupling->`Private`GetCoupling,RGEYe->`Private`GetYe},
